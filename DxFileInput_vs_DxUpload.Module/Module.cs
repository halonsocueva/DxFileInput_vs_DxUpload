...
namespace DxFileInput_vs_DxUpload.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class DxFileInput_vs_DxUploadModule : ModuleBase {
    public DxFileInput_vs_DxUploadModule() {
        //
        // DxFileInput_vs_DxUploadModule
        //
